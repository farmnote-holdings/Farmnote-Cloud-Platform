...
- **課題**: ゲノム改良への投資が、どのタイミングで生産に効果があらわれるかが不明確
- **解決策**: 本機能により、具体的なメイティングが将来の経産牛群に与える影響を数値で可視化する
